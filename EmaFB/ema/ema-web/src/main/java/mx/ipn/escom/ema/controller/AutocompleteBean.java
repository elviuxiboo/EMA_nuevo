...
public class AutocompleteBean implements  Serializable {
   ...
   public String listAutoComplete(List<String> list,  String query){
    ...
    public void setEtiqueta(String etiqueta) throws IOException {
        etiqueta = obtenCodigo();
	...
	public String obtenCodigo() throws IOException{
		...
		codigoObtenido = context.getExternalContext().getRequestParameterMap().get("textHtml:textAreaHtml");
